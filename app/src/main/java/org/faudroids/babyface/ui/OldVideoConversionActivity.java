...
@ContentView(R.layout.old_activity_video_conversion)
public class OldVideoConversionActivity extends AbstractActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
				...
				videoService.createVideo(new FaceMetaData(faceId))
						...
						.subscribe(new Action1<VideoConversionStatus>() {
							...
							public void call(VideoConversionStatus status) {
								OldVideoConversionActivity.this.status = status;
								updateStatus();
							}
						});
			}
		...
		showVideoButton.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Toast.makeText(OldVideoConversionActivity.this, "Stub", Toast.LENGTH_SHORT).show();
			}
		});
